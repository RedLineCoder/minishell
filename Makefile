...
UTILS_EXPANDER_SOURCES = $(UTILS_EXPANDER_PATH)/dollar.c $(UTILS_EXPANDER_PATH)/expander.c $(UTILS_EXPANDER_PATH)/wildcard.c $(UTILS_EXPANDER_PATH)/word_split.c 
UTILS_EXECUTOR_SOURCES = $(UTILS_EXECUTOR_PATH)/utils.c $(UTILS_EXECUTOR_PATH)/executes.c $(UTILS_EXECUTOR_PATH)/commands.c $(UTILS_EXECUTOR_PATH)/redirections.c $(UTILS_EXECUTOR_PATH)/heredocs.c
