...
# UTILS_EXPANDER_SOURCES = $(UTILS_EXPANDER_PATH)/expander.c $(UTILS_EXPANDER_PATH)/wildcard.c $(UTILS_EXPANDER_PATH)/dollar.c 
UTILS_EXPANDER_SOURCES = $(UTILS_EXPANDER_PATH)/expander_by_emur.c 
